...
import { addLecturesToCourse, createCourse, deleteCourse, deleteLectures, getAllCourses, getLectures, getProgress, updateCourse, updateProgress, updateLectures } from '../controller/courseController.js'
...
router.post('/progress', isLoggedIn, updateProgress);
router.get('/progress/:courseId', isLoggedIn, getProgress);
